...
import com.fanhehe.neckpets.business.wave.constant.WaveOpenMethod;
import com.fanhehe.neckpets.business.wave.constant.WavePrizeType;
import com.fanhehe.neckpets.business.wave.constant.WaveSource;
import com.fanhehe.neckpets.business.wave.constant.WaveConfigStatus;
...
@Table(name = "electric_wave_config", schema = "doll", catalog = "")
public class ElectricWaveConfig implements Serializable {
    private Long id;
    ...
    private WaveOpenMethod openMethod;
    private Integer openMethodValue;
    private WavePrizeType prizeType;
    ...
    private WaveConfigStatus status;
    ...
    public WaveOpenMethod getOpenMethod() {
        return openMethod;
    }

    public void setOpenMethod(WaveOpenMethod openMethod) {
    ...
    public WavePrizeType getPrizeType() {
        return prizeType;
    }

    public void setPrizeType(WavePrizeType prizeType) {
    ...
    public WaveConfigStatus getStatus() {
        return status;
    }

    public void setStatus(WaveConfigStatus status) {
        this.status = status;
    }
